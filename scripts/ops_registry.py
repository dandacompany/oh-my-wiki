...
OPS: tuple[OpSpec, ...] = (
    ...
    _det("links", "Entity-link suggestions + single/batch insertion.",
         "omw links {suggest|link} … [--from-suggestions]",
    ...
    _det("visibility", "Get/set a page's serve visibility.",
         "omw visibility {get|set} <relpath…> [public|private]",
    ...
    _det("setup", "Interactive setup wizard.",
         "omw setup [vault|hosts|search|fetch|serve|personas|import|viewer|agents|recall|gate|playwright] …"),
    ...
    _det("persona-run", "Dispatch a persona as an isolated one-shot subagent (any backend).",
         "omw persona-run <role> [--page P|--file F|--text T] [--backend B] [--runner host|hermes-kanban|hermes-delegate] [--assignee P] [--apply PROP]",
    ...
    _det("persona-bundle", "Run a named team of personas in sequence (any backend).",
         "omw persona-bundle {list|show <name>|run <name> [--page P] [--backend B] [--runner host|hermes-kanban] [--assignee P]}",
